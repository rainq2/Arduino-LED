...
const char* ssid = "Bananananana";       // 雙引號內，修改為你要 ESP32 連上的 WiFi 網路名稱 SSID
const char* password = "52695269";   // 雙引號內，鍵入此網路的密碼
...
String output2State = "off";  //設定字串變數 output2State，顯示 GPIO2 狀態。如果您要增加可控制的 GPIO 數目，請在這裡增加
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>ESP01-S Web Server</h1>");
